...
//     var movieToBeDeleted = await Movie.find(queryObj);
//     console.log(movieToBeDeleted)
//     if (movieToBeDeleted.length <= 0) {
//         res.status(400).send({
//             message: "Movie doesn't exist with the given name"
//         });
//     }
//     else{
//     await Movie.deleteOne({
//         _id: movieToBeDeleted.id
//     });
//     res.status(200).send({
//         message : "Successfully delete movie with id [ " + movieToBeDeleted._id + " ]"
//     });
// }
